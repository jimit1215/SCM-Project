	...
	<div class="agile_inner_breadcrumb">
		<div class="container">
			<ul class="w3_short">
				...
				<lottie-player src="https://assets10.lottiefiles.com/packages/lf20_o02kdakv.json"
					background="transparent" speed="1" style="width: 1100px; height: 300px;" loop
		...
		<form action="admin-product-code.php" method="post" enctype="multipart/form-data">
			...
			<div class="mb-3">
				<div class="mb-3">
					...
					<input type="text" required minlength=4 maxlength="50" class="form-control"
						id="exampleInputProductName1" name="product_name" aria-describedby="emailHelp" required>
				</div>
				<label for="exampleInputPhoto1" class="form-label">Photo</label>
				<input type="file" id="exampleInputPhoto1" name="image" placeholder="Please insert an image file..."
					accept="image/*" required />
			</div>

			<div class="mb-3">
				<label for="exampleInputPrice1" class="form-label">Price</label>
				<input type="number" required minlength="1000" class="form-control" id="exampleInputPrice" name="cost">
			</div>
			<div class="mb-3">
				<label for="exampleInputDescription1" class="form-label">Description</label>
				<p>
					<textarea rows="5" minlength=10 maxlength=300 class="form-control" cols="50"
				...
				while ($row = mysqli_fetch_array($rs)) {
					...
					<tr>
						...
						<td>
							...
							<a href="admin-product.php?id=<?php print $row[0] ?>"
